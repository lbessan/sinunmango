...
export async function POST(req: NextRequest) {
  ...
  // Primer día del mes actual para filtrar movimientos del mes
...
REGLAS CRÍTICAS PARA REGISTRAR MOVIMIENTOS:
- El campo "monto" SIEMPRE es POSITIVO (ej: 5000, nunca -5000)
- Para gastos: "tipo_movimiento": "Gasto"
- Para ingresos/cobros/sueldos: "tipo_movimiento": "Ingreso"
