    ...
    <div className="max-w-2xl mx-auto space-y-5">
      ...
      >
        ...
        <div className="border-t border-slate-50 pt-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-400">
                La preferencia se guarda — la implementación visual está en progreso.
              </p>
            </div>
          ...
          {darkMode && (
            <div className="mt-3 flex items-center gap-2 text-xs text-amber-600 bg-amber-50 border border-amber-100 px-3 py-2 rounded-lg">
              <Info size={12} className="shrink-0" />
              Preferencia guardada. El modo oscuro completo estará disponible próximamente.
            </div>
          )}
        </div>
      </Section>
